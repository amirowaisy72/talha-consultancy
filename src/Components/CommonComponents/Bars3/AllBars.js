            ...
            <ul className="uael-nav-menu uael-nav-menu-custom uael-custom-wrapper">
              ...
              >
                <NavLink
                  ...
                  style={{
                    border: location.pathname === '/offshore/overview' ? '2px solid black' : ''  
                  }}
                >
                  Overview
              ...
              >
                <NavLink
                  ...
                  className="uael-menu-item"
                  style={{
                    border: location.pathname === '/offshore/locations' ? '2px solid black' : ''  
                  }}
                >
                  Locations
                  <span className="uael-menu-toggle sub-arrow parent-item">
              ...
              >
                <NavLink
                  ...
                  className="uael-menu-item"
                  style={{
                    border: location.pathname === '/offshore/advantages' ? '2px solid black' : ''  
                  }}
                >
                  Advantages
                  <span className="uael-menu-toggle sub-arrow parent-item">
              ...
              >
                <NavLink
                  ...
                  className="uael-menu-item"
                  style={{
                    border: location.pathname === '/offshore/consultation' ? '2px solid black' : ''  
                  }}
                >
                  Consultation
                  <span className="uael-menu-toggle sub-arrow parent-item">
